...
def disp(top):
    ...
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated"),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp(top)],width=20,bg='white',fg='black')
...
def disp1(top):
    ...
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated"),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp1(top)],width=20,bg='white',fg='black')
    myb2.grid(row=i+3,column=5)
...
def disp2(top):
    ...
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated"),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp2(top)],width=20,bg='white',fg='black')
    myb2.grid(row=i+3,column=5)
...
def disp3(top):
    ...
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated"),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp3(top)],width=20,bg='white',fg='black')
    myb2.grid(row=i+3,column=5)
...
def disp4(top):
    ...
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated"),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp4(top)],width=20,bg='white',fg='black')
    myb2.grid(row=i+3,column=5)
...
def disp5(top):
    ...
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated"),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp5(top)],width=20,bg='white',fg='black')
    myb2.grid(row=i+3,column=5)
