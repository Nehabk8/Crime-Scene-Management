...
def Login():
	...
	lblNameDes4=Label(DataframeLeft, text="Police Dept ID: ", font=("times new roman",12, "bold"), padx=2, pady=6,bg='yellow')
...
def update(e,a,b,d):
    ...
    if d.get()=="user_id":
        ...
        c.execute("UPDATE "+e.get()+" set "+d.get()+'='+b.get()+" WHERE "+d.get()+'='+a.get())
    conn.commit()
...
def disp(top):
    ...
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated to "+txtent1.get()),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp(top)],width=20,bg='blue',fg='black')
...
def disp1(top):
    ...
    txtent1. grid(row=i+3, column=4)
    txtent1.insert(INSERT,'New ID')
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated to "+txtent1.get()),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp1(top)],width=20,bg='blue',fg='black')
    myb2.grid(row=i+3,column=5)
...
def disp2(top):
    ...
    txtent1. grid(row=i+3, column=4)
    txtent1.insert(INSERT,'New ID')
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated to "+txtent1.get()),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp2(top)],width=20,bg='blue',fg='black')
    myb2.grid(row=i+3,column=5)
...
def disp3(top):
    ...
    txtent1. grid(row=i+3, column=4)
    txtent1.insert(INSERT,'New ID')
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated to "+txtent1.get()),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp3(top)],width=20,bg='blue',fg='black')
    myb2.grid(row=i+3,column=5)
...
def disp4(top):
    ...
    txtent1. grid(row=i+3, column=4)
    txtent1.insert(INSERT,'New ID')
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated to "+txtent1.get()),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp4(top)],width=20,bg='blue',fg='black')
    myb2.grid(row=i+3,column=5)
...
def disp5(top):
    ...
    txtent1. grid(row=i+3, column=4)
    txtent1.insert(INSERT,'New ID')
    myb2=Button(top1,text='Update',command=lambda:[messagebox.showinfo("Update","Record updated to "+txtent1.get()),update(txtent3,txtent,txtent1,txtent2),top1.destroy(),disp5(top)],width=20,bg='blue',fg='black')
    myb2.grid(row=i+3,column=5)
