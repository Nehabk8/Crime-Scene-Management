...
#dataframe
Dataframe=Frame(root, bd=20, relief=RIDGE,bg='blue')
...
lblNameUserID71=Label(Detailsframe, text="User ID: ", font=("times new roman",12, "bold"), padx=2, pady=6,bg='blue')
...
lblNameCaseID72=Label(Detailsframe, text="Case ID: ", font=("times new roman",12, "bold"), padx=2, pady=6,bg='blue')
...
lblNameCaseID73=Label(Detailsframe, text="Criminal Id: : ", font=("times new roman",12, "bold"), padx=2, pady=6,bg='blue')
...
lblNameCaseID74=Label(Detailsframe, text="Victim: ", font=("times new roman",12, "bold"), padx=2, pady=6,bg='blue')
...
lblNameCaseID75=Label(Detailsframe, text="Police ID: ", font=("times new roman",12, "bold"), padx=2, pady=6,bg='blue')
...
lblNameCaseID76=Label(Detailsframe, text="Criminal ID: ", font=("times new roman",12, "bold"), padx=2, pady=6,bg='blue')
